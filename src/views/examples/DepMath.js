...
const DepMath = () => {
  ...
  return (
    <>
        ...
        <ul>
        <li><a href="/histoire" style={{fontWeight:"300",color:"black",fontSize:"18px"}}>Licence Mathématiques Appliquées</a></li><br/>
        <li><a href="/histoire" style={{fontWeight:"300",color:"black",fontSize:"18px"}}>Master professionnel : Data Science</a></li><br/>
        </ul>
        <div className="title">
            <h3 style={{fontWeight:'300'}}>
            <Row>Equipe:</Row></h3>
        </div>
        <p><strong>Directeur: </strong>Mohamed ELOUED</p>
        <p><strong>Mail: </strong><a href="mailto:  wadyel@yahoo.fr" style={{fontWeight:"300",color:"black",fontSize:"15px",textDecoration:'underline'}}>  wadyel@yahoo.fr</a>
        </p>
