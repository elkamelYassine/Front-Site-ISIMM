...
function ProfesseurNavbar({ changeColor, color }) {
            ...
            <Nav navbar>
              <UncontrolledDropdown nav inNavbar>
                <DropdownToggle
                  ...
                  nav
                  onClick={(e) => navigate("/professeur/emploi")}
                  role="button"
                >
                  Emploi
                </DropdownToggle>
              ...
              <UncontrolledDropdown nav inNavbar>
                ...
                <DropdownMenu>
                  <DropdownItem>Programmer une séance rattrapage</DropdownItem>
  ...
  ProfesseurNavbar.prototype = {
    changeColor: PropTypes.bool.isRequired,
    color: PropTypes.string,
  };
}

export default ProfesseurNavbar;
